...
在本文档中，描述了PostgreSQL对于数据库管理员和系统开发人员的内部结构。 

PostgreSQL是一个开源的多用途关系型数据库系统，在世界各地广泛使用。 它是一个集成子系统的庞大系统，每个子系统都有独特的复杂特征，协同工作。 尽管理解内部机制对于使用PostgreSQL进行管理和集成至关重要，但其庞大性和复杂性阻止了它。 本文档的主要目的是解释每个子系统是如何工作的，并且提供PostgreSQL的全貌。
...
作为日本PostgreSQL用户组(2010-2016年)的负责人，我在日本组织了六年多来最大的PostgreSQL(非商业)技术[研讨会/讲座](http://www.postgresql.jp/wg/shikumi/)，并在2013年担任了日本PostgreSQL会议的项目委员会主席，并在2008年和2009年担任了成员。 

他年轻时曾在南美住过几年。 最近，他有时会回到那里。

从2018年5月起，我将在爱尔兰都柏林工作；我目前正准备从日本搬迁。 

[Github](https://github.com/s-hironobu/)   [Blog](http://www.interdb.jp/blog/)

## 联系

在发送消息之前请先阅读此[常见问题](http://www.interdb.jp/pg/faq.html)解答。 
