...
![Fig. 5.1. Transaction ids in PostgreSQL.](imgs/ch5/fig-5-01.png)
...
![Fig. 5.2. Tuple structure.](imgs/ch5/fig-5-02.png)
...
![Fig. 5.3. Representation of tuples.](imgs/ch5/fig-5-03.png)
...
![Fig. 5.4. Tuple insertion.](imgs/ch5/fig-5-04.png)
...
![Fig. 5.5. Tuple deletion.](imgs/ch5/fig-5-05.png)
...
![Fig. 5.6. Update the row twice.](imgs/ch5/fig-5-06.png)
...
![Fig. 5.7. How the clog operates.](imgs/ch5/fig-5-07.png)
...
![Fig. 5.8. Examples of transaction snapshot representation.](imgs/ch5/fig-5-08.png)
...
![Fig. 5.9. Transaction manager and transactions.](imgs/ch5/fig-5-09.png)
...
![Fig. 5.10. Scenario to describe visibility check.](imgs/ch5/fig-5-10.png)
...
![code-5-01](imgs/ch5/code-5-01.png)
...
![code-5-02](imgs/ch5/code-5-02.png)
...
![Fig. 5.11. Three internal blocks in ExecUpdate.](imgs/ch5/fig-5-11.png)
...
![code-5-03](imgs/ch5/code-5-03.png)
...
![code-5-04](imgs/ch5/code-5-04.png)
...
![code-5-05](imgs/ch5/code-5-05.png)
...
![Fig. 5.12. Write-Skew schedule and its precedence graph.](imgs/ch5/fig-5-12.png)
...
![Fig. 5.13. Write-Skew scenario.](imgs/ch5/fig-5-13.png)

假设所有的命令都使用索引扫描。 因此，执行这些命令时，它们将读取堆元组和索引页，其中每个元组都包含指向相应堆元组的索引元组。 见图5.14。

**图. 5.14. 图5.13所示场景中索引与表之间的关系**

![Fig. 5.14. Relationship between the index and table in the scenario shown in Fig. 5.13.](imgs/ch5/fig-5-14.png)
...
![Fig. 5.15. SIREAD locks and rw-conflicts, and schedule of the scenario shown in Fig. 5.13.](imgs/ch5/fig-5-15.png)
...
![Fig. 5.16. Other Write-Skew scenarios.](imgs/ch5/fig-5-16.png)
...
![Fig. 5.17. Scenario where false-positive serialization anomaly occurs.](imgs/ch5/fig-5-17.png)
...
![Fig. 5.18. False-positive anomaly (1) – Using sequential scan.](imgs/ch5/fig-5-18.png)
...
![Fig. 5.19. False-positive anomaly (2) – Index scan using the same index page.](imgs/ch5/fig-5-19.png)
...
![Fig. 5.20. Wraparound problem.](imgs/ch5/fig-5-20.png)
...
![Fig. 5.21. Freeze process.](imgs/ch5/fig-5-21.png)
